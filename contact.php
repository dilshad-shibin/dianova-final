...
<body class="homepage-1">
    ...
    <div class="main">
        ...
        <section class="contact-us section ptb_100">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="single-head">
                                ...
                                <div class="single-info">
                                    ...
                                    <h3>Address</h3>
                                    <ul>
                                        <li>Opp. Baselious College, Manorama Junction, Good Shepherd Road, Kottayam-1</li>
                                    </ul>
                                </div>
                                <div class="single-info">
                                    <div class="info-icon">
                                    ...
                                    <h3>Phone Number</h3>
                                    <ul>
                                        <li><a href="tel:0481 2303722">04812303722</a></li>
                                        <li><a href="tel:0481 2583722">0481 2583722</a></li>
                                    </ul>
                                </div>
                                <div class="single-info">
                                    <div class="info-icon">
                                    ...
                                    <h3>Email Support</h3>
                                    <ul>
                                        <li><a href="mailto:dianovalaborateries@gmail.com">dianovalaborateries@gmail.com</a></li>
                                    </ul>
                                </div>
